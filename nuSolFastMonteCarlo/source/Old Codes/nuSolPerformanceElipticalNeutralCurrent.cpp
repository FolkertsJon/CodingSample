...
double solarBackground (double radius, double inclination){
  ...
  flux = flux*detectorArea;//angularView; I think this is superfluous
...
int main(){
  ...
  //  Control Variabes!
  double timeStep = 1*kUnits::ms;// time step for iterating
  ...
  double closest = 1*kUnits::AU;//5*kUnits::solarRadii;
  double furthest = 1*kUnits::AU;//1.1*kUnits::mercurySunDistance;
  double a = (closest+furthest)/2;// semi-major axis
